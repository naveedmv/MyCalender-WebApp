...
$(document).ready(function() {
    ...
    $('#eventList table tbody').on('click', 'td button.btnDelete', deleteevent );


    // editevent button click
    $('#eventList table tbody').on('click', 'td button.btnEdit', editevent);
...
function populateTable() {
    ...
    $.getJSON( '/eventlist', function( data ) {
        ...
        $.each(data, function(){
            ...
            tableContent += '<td><button id="btnEdit" class="btnEdit" style="background-color: orange;" type="Edit" value="' + this._id + '">Delete</button></td>';;
            tableContent += '</tr>';
        });
